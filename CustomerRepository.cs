...
{
    public class CustomerRepository : ISubscriptionRepository
    {
        public Customer GetById(int customerId)
        {
            ...
            if (CustomerRepositoryDatabase.Database.ContainsKey(customerId))
                return CustomerRepositoryDatabase.Database[customerId];

            throw new ArgumentException($"Customer with id {customerId} does not exist");
        }
    }

    internal static class CustomerRepositoryDatabase
    {
